...
for gal in gals:
    ...
    for filter in ['VIS','H']:
        try:
            ...
            sbf, sbfmag, total_bckgr, sma, mzp = MainPipeline(data_path, file_path=file_path, field_path=field_path, image_path=image_path, make_plots=True, plot_plots=False, psf=psf, maxarea_sourcemask=None, filter=filter, background_estimation=True, background=None, ellipsefitter='v6', sma_rescale=0.6)
...
comp_gals.write("comp_gals.csv", format="csv", overwrite=True)
